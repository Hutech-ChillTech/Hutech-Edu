...
import { gamificationService, type UserStats } from "../../service/gamification.service";
      ...
      <Card className={styles.summaryCard}>
        <div className={styles.summary}>
          <div className={styles.summaryItem}>
            <span className={styles.summaryValue}>{stats.experiencePoints.toLocaleString()}</span>
          ...
          <div className={styles.summaryItem}>
            <span className={styles.summaryValue}>{stats.totalCoursesCompleted}</span>
      ...
      <Card className={styles.timelineCard} style={{ marginTop: '1.5rem' }}>
        <Timeline
          ...
          items={stats.recentXP.map((transaction) => ({
            ...
            color: 'green',
            label: new Date(transaction.created_at).toLocaleDateString('vi-VN', {
              year: 'numeric',
              month: 'short',
              day: 'numeric',
              hour: '2-digit',
            ...
            children: (
              <div className={styles.activityItem}>
                <div className={styles.activityContent}>
                  ...
                  <span className={styles.activityXP}>+{transaction.amount} XP</span>
                </div>
              </div>
            ),
          }))}
