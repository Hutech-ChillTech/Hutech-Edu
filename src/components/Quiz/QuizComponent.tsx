...
const QuizComponent: React.FC<QuizComponentProps> = ({ chapterId }) => {
    ...
    useEffect(() => {
        const fetchQuizData = async () => {
            try {
                ...
                const questionsData = await quizService.getQuestionsByQuiz(quiz.chapterQuizId);
                                ...
                                return (
                                    <div key={q.questionId} className={styles.reviewItem}>
                                        ...
                                        <div className={styles.reviewAnswers}>
                                            <p><strong>Đáp án của bạn:</strong> {userAnswer !== undefined ? q.options[userAnswer] : 'Chưa trả lời'}</p>
                                            {!isCorrect && (
                            ...
                            return (
                                ...
                                >
                                    <div className={styles.optionRadio}>
                                        {isSelected && <div className={styles.optionRadioInner}></div>}
                                    </div>
