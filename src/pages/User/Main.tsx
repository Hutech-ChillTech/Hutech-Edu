  ...
  return (
    <div className={styles["blog-main"]}>
      ...
      <div className={styles["hero-section"]}>
        ...
        <p className={styles["hero-subtitle"]}>Cùng bạn định hướng tương lai lập trình!</p>
      </div>
          ...
          {posts.map((post, index) => (
            <div className="col-md-6 mb-4" key={index}>
              <div className={`${styles["blog-card"]} d-flex shadow-sm`}>
                <img src={post.img} className={styles["blog-img"]} alt={post.title} />
                <div className={`${styles["blog-content"]} p-3 d-flex flex-column justify-content-between`}>
                  <div>
