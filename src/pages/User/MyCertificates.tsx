...
import { Card, Button, Badge, Space, Skeleton, Empty, Typography, Row, Col, Divider } from "antd";
import { 
  DownloadOutlined, 
  EyeOutlined, 
...
const MyCertificates: React.FC = () => {
  ...
  const fetchCertificates = async () => {
    try {
      ...
      showToast("error", error.message || "Không thể tải danh sách chứng chỉ");
    } finally {
      setLoading(false);
    }
  };
          ...
          <Card className="empty-state-card">
            <Empty 
              ...
              description={
                <div>
                  <Paragraph>
                    Bạn chưa có chứng chỉ nào. Hãy hoàn thành khóa học để nhận chứng chỉ nhé!
                  </Paragraph>
                </div>
              }
            >
