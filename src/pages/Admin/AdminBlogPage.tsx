...
import type { BlogPost, Tag, Category } from '../../types/blog.types';
  ...
  const columns: ColumnsType<BlogPost> = [
    ...
    },
    {
      ...
      render: (status) => {
        ...
        return <AntTag color={colors[status as keyof typeof colors]}>{status}</AntTag>;
      },
    },
    {
      title: 'Tags',
    ...
    <div className="admin-blog-page">
      ...
      >
        ...
        >
          ...
          >
            <TextArea
              placeholder="Nội dung blog (hỗ trợ HTML)"
              rows={10}
            />
          </Form.Item>
